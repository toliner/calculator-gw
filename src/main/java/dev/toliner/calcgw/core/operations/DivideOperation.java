...
public abstract class DivideOperation implements Operation {

    @Contract("_, _ -> new")
    public static Lazy of(@NotNull Expression first, @NotNull Expression second) {
    ...
    private static final class Integer extends DivideOperation {
    ...
    private static final class Fraction extends DivideOperation {
    ...
    private static final class Lazy extends DivideOperation {
